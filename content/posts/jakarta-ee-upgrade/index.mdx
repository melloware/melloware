...
## Java classes/packages migration

Most importantly, all `javax` packages will be upgraded to their `jakarta` equivalent. As an added bonus it will update all
bean validation messages as well.
