...
Quarkus offers the ability to build Uber-JARs by adding `quarkus.package.type=uber-jar` to your `application.properties` file.

QuarkusFaces users have been unable to build Uber-JARs due to MyFaces' lack of support for the `quarkus.package.type=uber-jar` property. 
...
java -jar target/mapp-1.0-SNAPSHOT-runner.jar
```
